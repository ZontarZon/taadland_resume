    ...
    <div>
      ...
      <div className="body_content_text">
        ...
        <p>
          ...
          University of South Carolina in Columbia, SC. Since then I've been
          ...
          on a website, it's my jam.
        </p>
        <p>
          I've always had a fascination with sci-fi and monsters. It has allowed
          me to really connect with my work in EdTech to entertain and educate
          students with child-friendly UI designs filled with fun, memorable
          graphics and other visuals.
        </p>
        <p>
          As for my adult audience, I have worked many different jobs in both
          software development and the arts; I've assisted several professors in
          their research, including full-stack web development for the Ward One
